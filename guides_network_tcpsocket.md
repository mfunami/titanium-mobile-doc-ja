# APIカタログ(ネットワーク編) - TCPSocketによる通信 #
```
...
## 関連するKitchenSinkソース ##
  ...
  * http://github.com/appcelerator/KitchenSink/blob/master/KitchenSink/Resources/examples/sockets.js

## 関連するAPIドキュメント ##
  * http://developer.appcelerator.com/apidoc/mobile/latest/Titanium.Network.TCPSocket-object.html
